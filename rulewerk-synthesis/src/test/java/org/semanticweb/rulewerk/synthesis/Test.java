...
public class Test {
	...
	public static void main (String[] arg) throws IOException {
		...
		Rule r1 = Expressions.makeRule(Expressions.makePositiveLiteral("ancestor", x0, x2, Expressions.makeSetConstruct(cr1)), 
				Expressions.makePositiveLiteral("parent", x0, x1), Expressions.makePositiveLiteral("parent", x1, x2),
				Expressions.makePositiveLiteral("Rule", cr1));
		Rule r2 = Expressions.makeRule(Expressions.makePositiveLiteral("ancestor", x0, x2, cr2Uu), 
				Expressions.makePositiveLiteral("ancestor", x0, x1, u), Expressions.makePositiveLiteral("parent", x2, x1),
				Expressions.makePositiveLiteral("Rule", cr2));
		Rule r3 = Expressions.makeRule(Expressions.makePositiveLiteral("ancestor", x0, x1, Expressions.makeSetConstruct(cr3)), 
				Expressions.makePositiveLiteral("parent", x0, x1),
				Expressions.makePositiveLiteral("Rule", cr3));
		
		Fact f1 = Expressions.makeFact("parent", c1, c2);
		Fact f2 = Expressions.makeFact("parent", c1, c3);
		Fact f3 = Expressions.makeFact("parent", c2, c4);
		Fact f4 = Expressions.makeFact("parent", c3, c4);
		Fact f5 = Expressions.makeFact("parent", c4, c5);
		...
		kb.addStatement(Expressions.makeRule(Expressions.makePositiveLiteral("Ans", c1, x1, x2), 
				Expressions.makePositiveLiteral("ancestor", c1, x1, x3), Expressions.makePositiveLiteral("in", x2, x3)));
		
		kb.addStatement(Expressions.makeRule(Expressions.makePositiveLiteral("Ans2", x3, cr1), 
				Expressions.makePositiveLiteral("parent", x0, x1), Expressions.makePositiveLiteral("parent", x1, x2),
				Expressions.makePositiveLiteral("Rule", cr1), Expressions.makePositiveLiteral("empty", x3)));
		...
		try (final Reasoner reasoner = new VLogReasoner(kb)) {
			...
			ReasoningUtils.printOutQueryAnswers(Expressions.makePositiveLiteral("parent", x0, x1, x2), reasoner);
			ReasoningUtils.printOutQueryAnswers(Expressions.makePositiveLiteral("ancestor", x0, x1, x2), reasoner);
			ReasoningUtils.printOutQueryAnswers(Expressions.makePositiveLiteral("Ans", x0, x1, x2), reasoner);
